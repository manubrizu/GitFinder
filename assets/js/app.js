...
let apiUrl = "https://api.github.com/users/manubrizu";
...
window.updateProfile = function (profileUrl) {
    ...
    $repoPanel.innerHTML = `
        <div class="card repo-skeleton">
            <div class="card_body">
                <div class="skeleton title-skeleton"></div>
                <skeleton class="skeleton text-skeleton text-1"></skeleton>
                <skeleton class="skeleton text-skeleton text-2"></skeleton>
            </div>
    ...
    fetchData(followerUrl, function (data) {
        ...
        if(data.length) {
            for(const item of data) {
                ...
                $followerPanel.append($followerCard);
            }
        } else {
            $followerPanel.innerHTML = `
                <div class="error-content">
    ...
    fetchData(followingUrl, function (data) {
        ...
        if(data.length) {
            for(const item of data) {
                ...
                $followingPanel.append($followingCard);
            }
        } else {
            $followingPanel.innerHTML = `
                <div class="error-content">
